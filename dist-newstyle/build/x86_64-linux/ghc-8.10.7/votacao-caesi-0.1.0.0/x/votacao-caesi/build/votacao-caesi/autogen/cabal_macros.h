...
/* package votacao-caesi-0.1.0.0 */
#ifndef VERSION_votacao_caesi
#define VERSION_votacao_caesi "0.1.0.0"
#endif /* VERSION_votacao_caesi */
#ifndef MIN_VERSION_votacao_caesi
#define MIN_VERSION_votacao_caesi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_votacao_caesi */
...
#define CURRENT_COMPONENT_ID "votacao-caesi-0.1.0.0-inplace-votacao-caesi"
